...
class MyBooksControllerTest < ActionController::TestCase
  ...
  test "should create my_book" do
    assert_difference('MyBook.count') do
      post :create, my_book: { author: @my_book.author, date: @my_book.date, price: @my_book.price, publisher: @my_book.publisher, title: @my_book.title }
    end
  ...
  test "should update my_book" do
    patch :update, id: @my_book, my_book: { author: @my_book.author, date: @my_book.date, price: @my_book.price, publisher: @my_book.publisher, title: @my_book.title }
    assert_redirected_to my_book_path(assigns(:my_book))
  end
